...
// // CRIANDO RESULTADOS DO BUSCADOR NO HTML
// // obs: o resultado da pesquisa deve retornar a imagem, o titulo,
// //      e a descrição do produto;

// function constructResult (img,titulo,descricao) {
    
//     const divResultado = document.querySelector(".divResultados");
